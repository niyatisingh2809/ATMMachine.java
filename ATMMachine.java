...
class ATM {
    ...
    // Method to handle user input for double values
    private double getInputAmount(String prompt) {
        while (true) {
    ...
    public void start() {
        while (true) {
            try {
                ...
                switch (choice) {
                    case 1:
                        double withdrawAmount = getInputAmount("Enter amount to withdraw: ");
                        withdraw(withdrawAmount);
                        break;
                    case 2:
                        double depositAmount = getInputAmount("Enter amount to deposit: ");
